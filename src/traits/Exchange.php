...
trait Exchange
	...
	private function _isNotCrypto(string $name):bool
	    {
		$list = ["EUR", "RUB", "KZT", "BYN", "UAH", "CNY", "GEL"];
	...
	private function _recalculate(array $tickers, string $currency, string $newcurrency = "", float $rate = 1, string $cryptocurrency = ""):array
	    {
		$crypto = "BTC";
