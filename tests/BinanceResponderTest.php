...
use \AM\Exchanges\BinanceResponder as Responder;
use \Logics\Tests\InternalWebServer;

/**
 * Binance Responder test
 *
...
class BinanceResponderTest extends TestCase
    {
...
//file_put_contents(__DIR__ . "/datasets/binance/expected_default.html", $html);

		$expected  = file_get_contents(__DIR__ . "/datasets/binance/expected_default.html");
		$this->assertEquals($expected, $html);

		$responder = new Responder();
		$html      = $responder->getTicker("ALL", "ETH");
//file_put_contents(__DIR__ . "/datasets/binance/expected_eth.html", $html);

		$expected  = file_get_contents(__DIR__ . "/datasets/binance/expected_eth.html");
		$this->assertEquals($expected, $html);
...
//file_put_contents(__DIR__ . "/datasets/binance/expected_usdt.html", $html);

		$expected  = file_get_contents(__DIR__ . "/datasets/binance/expected_usdt.html");
		$this->assertEquals($expected, $html);
...
//file_put_contents(__DIR__ . "/datasets/binance/expected_eur.html", $html);

		$expected  = file_get_contents(__DIR__ . "/datasets/binance/expected_eur.html");
...
//file_put_contents(__DIR__ . "/datasets/binance/expected_eur.json", $json);
		$expected  = file_get_contents(__DIR__ . "/datasets/binance/expected_eur.json");

		$this->assertEquals($expected, $json);

		$json     = $responder->getTicker("USDT_BTC", "EUR", "json");
//file_put_contents(__DIR__ . "/datasets/binance/expected_eur_btc.json", $json);

		$expected = file_get_contents(__DIR__ . "/datasets/binance/expected_eur_btc.json");
		$this->assertEquals($expected, $json);

		$json     = $responder->getTicker("USDT_LTC", "USDT", "json");
//file_put_contents(__DIR__ . "/datasets/binance/expected_eur_ltc.json", $json);
		$expected = file_get_contents(__DIR__ . "/datasets/binance/expected_eur_ltc.json");
		$this->assertEquals($expected, $json);
