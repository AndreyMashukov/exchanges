...
use \AM\Exchanges\BitfinexResponder as Responder;
use \Logics\Tests\InternalWebServer;

/**
 * Bitfinex Responder test
 *
...
class BitfinexResponderTest extends TestCase
    {
...
//		file_put_contents(__DIR__ . "/datasets/bitfinex/expected_default.html", $html);
		$expected  = file_get_contents(__DIR__ . "/datasets/bitfinex/expected_default.html");
		$this->assertEquals($expected, $html);

		$responder = new Responder();
		$html      = $responder->getTicker("ALL", "ETH");
//		file_put_contents(__DIR__ . "/datasets/bitfinex/expected_eth.html", $html);

		$expected  = file_get_contents(__DIR__ . "/datasets/bitfinex/expected_eth.html");
		$this->assertEquals($expected, $html);
...
//		file_put_contents(__DIR__ . "/datasets/bitfinex/expected_usdt.html", $html);

		$expected  = file_get_contents(__DIR__ . "/datasets/bitfinex/expected_usdt.html");
		$this->assertEquals($expected, $html);
...
//		file_put_contents(__DIR__ . "/datasets/bitfinex/expected_eur.html", $html);

		$expected  = file_get_contents(__DIR__ . "/datasets/bitfinex/expected_eur.html");
...
//		file_put_contents(__DIR__ . "/datasets/bitfinex/expected_eur_ltc.json", $json);
	...
	public function testShouldSaveOftenRequestsData()
		...
		define("BITFINEX_CACHE_ON", true);
		define("BITFINEX_REQUESTS_LIMIT", 20);
