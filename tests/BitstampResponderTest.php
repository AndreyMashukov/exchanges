...
use \AM\Exchanges\BitstampResponder as Responder;
use \Logics\Tests\InternalWebServer;

/**
 * Bitstamp Responder test
 *
...
class BitstampResponderTest extends TestCase
    {
...
//file_put_contents(__DIR__ . "/datasets/bitstamp/expected_default.html", $html);
		$expected  = file_get_contents(__DIR__ . "/datasets/bitstamp/expected_default.html");
		$this->assertEquals($expected, $html);

		$responder = new Responder();
		$html      = $responder->getTicker("ALL", "ETH");
//file_put_contents(__DIR__ . "/datasets/bitstamp/expected_eth.html", $html);

		$expected  = file_get_contents(__DIR__ . "/datasets/bitstamp/expected_eth.html");
		$this->assertEquals($expected, $html);
...
//file_put_contents(__DIR__ . "/datasets/bitstamp/expected_usdt.html", $html);

		$expected  = file_get_contents(__DIR__ . "/datasets/bitstamp/expected_usdt.html");
		$this->assertEquals($expected, $html);
...
//file_put_contents(__DIR__ . "/datasets/bitstamp/expected_eur.html", $html);
		$expected  = file_get_contents(__DIR__ . "/datasets/bitstamp/expected_eur.html");
...
//file_put_contents(__DIR__ . "/datasets/bitstamp/expected_eur.json", $json);
		$expected  = file_get_contents(__DIR__ . "/datasets/bitstamp/expected_eur.json");

		$this->assertEquals($expected, $json);

		$json     = $responder->getTicker("USDT_BTC", "EUR", "json");
//file_put_contents(__DIR__ . "/datasets/bitstamp/expected_eur_btc.json", $json);

		$expected = file_get_contents(__DIR__ . "/datasets/bitstamp/expected_eur_btc.json");
		$this->assertEquals($expected, $json);

		$json     = $responder->getTicker("USDT_LTC", "USDT", "json");
//file_put_contents(__DIR__ . "/datasets/bitstamp/expected_eur_ltc.json", $json);
		$expected = file_get_contents(__DIR__ . "/datasets/bitstamp/expected_eur_ltc.json");
		$this->assertEquals($expected, $json);
	...
	public function testShouldSaveOftenRequestsData()
		...
		define("BITSTAMP_CACHE_ON", true);
		define("BITSTAMP_REQUESTS_LIMIT", 20);
